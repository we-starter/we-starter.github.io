                    ...
                    <form className="form-app" action="/">
                        <div className="form-app__inner wallet-connect">
                            <div className="form-app__inner__wallets">
                                <div onClick={()=>{
                                    dispatch({type: HANDLE_WALLET_MODAL, walletModal: 'connecting'})
                                    //setConnecting(true)
                                    activate(injected).then(()=>{
                                        dispatch({type: HANDLE_WALLET_MODAL, walletModal: null})
                                        window && window.localStorage.setItem(GALLERY_SELECT_WEB3_CONTEXT, 'MetaMask')
                                    }).catch(()=>{

                                    })
                                }} className="form-app__inner__wallets__item" style={{borderRight: '1px rgba(235, 233, 227, 1) solid'}}>
                                    <img src={metamask}/>
