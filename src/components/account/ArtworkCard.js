        ...
        {isNFT ? (
          <div className='artwork-list__item'>
              ...
              <span className='artwork-list__badge'>
                <b
                  className={`artwork-list__badge-inner ${
                    true === 2 && 'artwork-list__badge-inner2'
                  } ${true === 3 && 'artwork-list__badge-inner3'}`}
                >
                  {1}
                </b>
              </span>
            ...
            <p className='artwork-list__author'>
              <FormattedMessage id='accountText1' />
              {figure.name}
            </p>
            ...
            >
              <FormattedMessage id='accountText2' />
            </button>
            <p className='artwork-list__token-id'>
              <FormattedMessage id='accountText5' />:{figure.tokenId}
            </p>
            ...
            <div className='artwork-list__votes'>
              {formatAmount(figure.points)}{' '}
              <FormattedMessage id='accountText3' />
            </div>
          </div>
        ) : (
          <div className='artwork-list__item'>
            ...
            <p className='artwork-list__author'>
              <FormattedMessage id='accountText1' /> {figure.info.name}
            </p>
            <button type='button' className='artwork-list__btn btn btn--gray'>
            ...
            <div className='artwork-list__votes'>
              ...
              <FormattedMessage id='accountText4' />
            </div>
          </div>
        )}
      </Grow>
