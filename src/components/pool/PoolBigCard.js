            ...
            <div className='card-pool__item card-pool__item--big'>
                ...
                <div className='card-pool__content'>
                    ...
                    <p className='card-pool__earn'>
                        <FormattedMessage id='poolText5' /> <br />
                        <FormattedMessage id='poolText6' />
                    </p>
                    <div>
                        <dl className='card-pool__dl'>
                            <div className='card-pool__dl-row'>
                                <dt className='card-pool__dl-dt'>
                                    <FormattedMessage id='poolText7' />
                                </dt>
                            ...
                            <div className='card-pool__dl-row'>
                                <dt className='card-pool__dl-dt'>
                                    <FormattedMessage id='poolText10' />
                                </dt>
                                <dd className='card-pool__dl-dd'>
                                    <b className='card-pool__dl-yellow'>
                                        {left}
                                    </b>
                                </dd>
                            </div>
