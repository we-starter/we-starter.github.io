...
import {GALLERY_SELECT_WEB3_CONTEXT, HANDLE_SHOW_TRANSACTION_MODAL, HANDLE_WALLET_MODAL} from "../../const";
            ...
            <div className="modal__box">
                <form className="form-app" action="/">
                    <div className="form-app__inner transction-submitted">
                        <div className="form-app__inner__header" style={{maxWidth: 'inherit'}}>
                            ACCOUNT
                        </div>
                        ...
                        <CopyToClipboard
                            ...
                            <div className="form-app__inner__frame" style={{marginBottom: 24}}>
                        ...
                        <button
                            ...
                            onClick={()=>{
                                deactivate()
                                dispatch({type: HANDLE_WALLET_MODAL, walletModal: null})
                                window && window.localStorage.setItem(GALLERY_SELECT_WEB3_CONTEXT, null)
                            }}
                        >
                            Disconnect Wallet
                        </button>
