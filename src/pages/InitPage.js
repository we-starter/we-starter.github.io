    ...
    return (
        <>
            ...
            {walletModal === 'connecting' && (
                <div className="modal-show">
                    <div className="wrapper">
                        <LoginModal onDismiss={()=>dispatch({type: HANDLE_WALLET_MODAL, walletModal: null})}/>
                    </div>
                </div>
            )}
            ...
            {walletModal === 'status' && (
                <div className="modal-show" style={{zIndex: 11}}>
                    <div className="wrapper">
                        <WalletModal
                            onClose={() => dispatch({type: HANDLE_WALLET_MODAL, walletModal: null})}
                            onChange={() => dispatch({type: HANDLE_WALLET_MODAL, walletModal: 'change'})}/>
                    </div>
                </div>
            )}
            ...
            {walletModal === 'change' && (
                <div className="modal-show">
                    <div className="wrapper">
                        <WalletChange
                            onClose={() => dispatch({type: HANDLE_WALLET_MODAL, walletModal: null})}
                            onCancel={() => dispatch({type: HANDLE_WALLET_MODAL, walletModal: 'status'})}/>
                    </div>
                </div>
            )}
