                            ...
                            return Promise.all(promise_list).then(
                                ([
                                    ...
                                    const totalPurchasedAmount = Web3.utils.toWei(new BigNumber(
                                        ...
                                        .dividedBy(new BigNumber(_ratio)).toFixed(6, 1).toString(),'ether')
                                  const totalPurchasedCurrency = Web3.utils.toWei(new BigNumber(
                                      Web3.utils.fromWei(totalOffered, 'ether')
                                  )
                                      .dividedBy(new BigNumber(_ratio)).toFixed(6, 1).toString(),'ether')
                                  ...
                                  return Object.assign({}, pool, {
                                        ...
                                        progress:
                                            new BigNumber(Web3.utils.fromWei(totalQuota, "ether"))
